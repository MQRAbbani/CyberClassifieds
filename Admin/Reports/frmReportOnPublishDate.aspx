<%@ Page Language="C#" MasterPageFile="~/Admin/AdminMasterPage.master" AutoEventWireup="true" CodeFile="frmReportOnPublishDate.aspx.cs" Inherits="Admin_Reports_frmReportOnPublishDate" Title="Untitled Page" %>
        ...
        <table style="background-color: #ffffff; height: 360px;">
            <tr>
                <td colspan="4" style="height: 21px">
                    <span style="text-decoration: underline"><span class="style2" 
                        style="font-size: x-large; color: #3399FF">
                        Report Genaration Based On Publishing&nbsp; Date</span><strong><span style="font-size: 14pt"> </span></strong>
                    </span>
                </td>
            </tr>
            <tr>
            ...
            <tr style="color: #000000">
                <td style="height: 21px; text-align: center;" colspan="2">
                    <strong>&nbsp;Reprot Based On Between Dates </strong>&nbsp;</td>
            ...
            <tr style="color: #000000">
             ...
             <tr>
            <td height="20px" colspan="4" style="font-size: small"><b><asp:Label runat="server" ID="lblIns" Text="Click the below buttons to get in different format of reports" ></asp:Label></b></td>
            </tr>
            <tr>
            <td colspan="2"><asp:Button ID="btnPdf" runat="server" Text="Convert To PDF" 
                    CausesValidation="False" onclick="btnPdf_Click" /></td>
            <td colspan="2"><asp:Button ID="btnXl" runat="server" Text="Convert To XL" 
                    CausesValidation="False" onclick="btnXl_Click" /></td>
            </tr>
            <tr>
                ...
                <td colspan="4" style="height: 57px">
                    ...
                    <asp:GridView ID="GridView1" AutoGenerateColumns="false" runat="server" Width="227px"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField ItemStyle-Width="100px" DataField="NewDop" HeaderText="Publish Date" />
